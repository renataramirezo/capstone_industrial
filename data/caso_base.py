...
nx.draw_networkx_edges(
    ...
    gf.pos,
    edgelist=ruta_arcos,
    edge_color="chocolate",    # o el color que desees
...
for nodo in nodos_a_cosechar_sk_t2:
    node_colors_rod_t2[Orden.index(nodo)] = "lightgreen"
for nodo in nodos_a_cosechar_t_t2:
    node_colors_rod_t2[Orden.index(nodo)] = "darkgreen"
...
nx.draw_networkx_edges(
    ...
    edge_color="darkorange",    # o el color que desees
    width=10             # más grueso para que destaque
)
